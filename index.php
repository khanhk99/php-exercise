    ...
    <div class="ui container">
        ...
        <div class="header">
            ...
            <div class="search">
                ...
                <div class="filter">
                    <form id="filterSearch" method="GET" action>
                        ...
                        <input type="date" name="startDateFilter" value="">
                        <input type="date" name="endDateFilter" value="">
                    </form>
                    <button class="ui button" form="filterSearch" type="submit">Filter</button>
                </div>
            </div>
            <!-- filter -->
        </div>
        ...
        <div class="main">
            ...
            <div class="pagination">
                ...
                <?php } ?>
                <?php if ((isset($_GET['page']) && $_GET['page'] < $total_page) || !isset($_GET['page'])) { ?>
